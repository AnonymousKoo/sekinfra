...
COMMANDS = {
    ...
    "CreateImplementationOutcome": CommandDefinition("CreateImplementationOutcome", "IMPLEMENTATION_OUTCOME", 1, "urn:sekinfra:schema:contracts:commands:create-implementation-outcome-payload:v1", 1, required_capability="implementation_outcome:write", executable=True),
    "RecordImplementationOutcomeApproval": CommandDefinition("RecordImplementationOutcomeApproval", "IMPLEMENTATION_OUTCOME", 1, "urn:sekinfra:schema:contracts:commands:record-implementation-outcome-approval-payload:v1", 1, required_capability="implementation_outcome:approve", executable=True),
    "ApproveImplementationOutcome": CommandDefinition("ApproveImplementationOutcome", "IMPLEMENTATION_OUTCOME", 1, "urn:sekinfra:schema:contracts:commands:approve-implementation-outcome-payload:v1", 1, required_capability="implementation_outcome:approve", executable=True),
    "RevokeImplementationOutcome": CommandDefinition("RevokeImplementationOutcome", "IMPLEMENTATION_OUTCOME", 1, "urn:sekinfra:schema:contracts:commands:revoke-implementation-outcome-payload:v1", 1, required_capability="implementation_outcome:revoke", executable=True),
