...
class CommandValidator:
    ...
    def _composed_schema(self, definition: CommandDefinition) -> dict[str, Any]:
        ...
        elif definition.command_type in ("CreateImplementationOutcome", "RecordOIAConversionDecision", "ProposeOngoingAgreement", "RecordOngoingPaymentVerification", "ProposeOngoingAccessGrant", "InitiateOngoingOffboarding"):
    ...
    def _semantic_failure(self, raw: dict[str, Any], definition: CommandDefinition) -> ValidationFailure | None:
        ...
        if definition.command_type == "CreateImplementationOutcome" and raw["payload"]["engagement_id"] != raw.get("engagement_id"):
            return self._failure(RuntimeReason.PAYLOAD_INVALID, "ImplementationOutcome payload must identify the command engagement")
