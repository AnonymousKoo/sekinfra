...
SCHEMA_FILES = (
    ...
    "commands/create-implementation-outcome.payload.schema.json", "commands/record-implementation-outcome-approval.payload.schema.json", "commands/approve-implementation-outcome.payload.schema.json", "commands/revoke-implementation-outcome.payload.schema.json",
    ...
    "domain/implementation-outcome.schema.json",
    ...
    "read-models/engagement-summary.schema.json", "read-models/onboarding-readiness.schema.json", "read-models/oia-assessment-status-view.schema.json", "read-models/oia-evidence-progress-view.schema.json", "read-models/oia-findings-summary-view.schema.json", "read-models/oia-findings-delivery-status-view.schema.json", "read-models/oia-engagement-progress-view.schema.json",
