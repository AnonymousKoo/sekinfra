...
EXPECTED_COMMANDS += ["CreateImplementationOutcome", "RecordImplementationOutcomeApproval", "ApproveImplementationOutcome", "RevokeImplementationOutcome"]
...
EXPECTED_SUBJECTS += ["IMPLEMENTATION_OUTCOME"]
