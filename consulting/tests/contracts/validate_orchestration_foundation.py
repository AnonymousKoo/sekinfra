...
IMPLEMENTATION_OUTCOME_COMMANDS = ["CreateImplementationOutcome", "RecordImplementationOutcomeApproval", "ApproveImplementationOutcome", "RevokeImplementationOutcome"]
IMPLEMENTATION_OUTCOME_EVENTS = ["implementation_outcome.draft_created", "implementation_outcome.approval_recorded", "implementation_outcome.approved", "implementation_outcome.revoked"]
