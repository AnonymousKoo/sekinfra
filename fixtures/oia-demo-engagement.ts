...
export const oiaDemoEngagement = {
  ...
  authority: {
    diagnosticAgreement: { technicalState: "VERIFIED", label: "Diagnostic agreement verified" },
    paymentCondition: { technicalState: "VERIFIED", label: "Payment condition verified" },
    accessApproval: { technicalState: "APPROVED", label: "Diagnostic access approved" },
    assessmentAccess: { technicalState: "ACTIVE", label: "Diagnostic access verified and active" },
...
export function projectClientEngagement(source: typeof oiaDemoEngagement) {
  ...
  return {
    ...
    scope: source.scope,
    access: {
      status: source.authority.assessmentAccess,
      approval: source.authority.accessApproval,
